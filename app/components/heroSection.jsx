            ...
            <div className="grid grid-cols-1 md:grid-cols-12">
                <div className="col-span-7 place-self-center mb-4 text-center sm:text-left">
                    ...
                    <p className='text-slate-400 text-base sm:text-lg  mb-6 lg:text-xl'>
                        Lorem Ipsum iversions of Lorem Ipsumsdgdagsdgsdggggsssssssssssss
                    </p>
                    <div className=''>
                ...
                <div className='col-span-5 mt-5  lg:mt-0 flex justify-center items-center  sm:place-content-center sm:justify-center'>
                    <div className='bg-slate-300 w-[250px] h-[250px] rounded-full relative flex justify-center items-center'>
                        <Image src="/images/img.png" alt="profile image" width={200} height={200} className='rounded-full ' />
                    </div>
                </div>
            </div>
        </section>
